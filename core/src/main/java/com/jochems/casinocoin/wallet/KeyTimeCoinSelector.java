 ...
 * Used as part of the implementation of {@link com.jochems.casinocoin.core.Wallet#setKeyRotationTime(java.util.Date)}.
 */
public class KeyTimeCoinSelector implements CoinSelector {
    ...
    /** A number of inputs chosen to avoid hitting {@link com.jochems.casinocoin.core.Transaction.MAX_STANDARD_TX_SIZE} */
