...
import com.jochems.casinocoin.core.StoredBlock;
import com.jochems.casinocoin.core.StoredTransactionOutput;
import com.jochems.casinocoin.core.StoredUndoableBlock;
...
public interface FullPrunedBlockStore extends BlockStore {
    ...
    /**
     * Gets a {@link com.jochems.casinocoin.core.StoredTransactionOutput} with the given hash and index, or null if none is found
     */
