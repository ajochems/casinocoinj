 ...
 *
 * <p>An AbstractBlockChain implementation must be connected to a {@link com.jochems.casinocoin.store.BlockStore} implementation. The chain object
 ...
 * the lightweight SPV mode, a {@link com.jochems.casinocoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.jochems.casinocoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            if (storedPrev == null) {
                ...
                checkDifficultyTransitionsNew(storedPrev, block);
