...
import com.jochems.casinocoin.params.*;
 ...
 * one for the main network ({@link com.jochems.casinocoin.params.MainNetParams}), one for the public test network, and two others that are
