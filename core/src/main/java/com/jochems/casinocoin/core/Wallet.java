...
package com.jochems.casinocoin.core;

import com.jochems.casinocoin.crypto.KeyCrypter;
import com.jochems.casinocoin.crypto.KeyCrypterException;
import com.jochems.casinocoin.crypto.KeyCrypterScrypt;
import com.jochems.casinocoin.script.Script;
import com.jochems.casinocoin.script.ScriptBuilder;
import com.jochems.casinocoin.script.ScriptChunk;
import com.jochems.casinocoin.store.UnreadableWalletException;
import com.jochems.casinocoin.store.WalletProtobufSerializer;
import com.jochems.casinocoin.utils.ListenerRegistration;
import com.jochems.casinocoin.utils.Threading;
import com.jochems.casinocoin.wallet.*;
...
import static com.jochems.casinocoin.core.Utils.bitcoinValueToFriendlyString;
import static com.jochems.casinocoin.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.jochems.casinocoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
        ...
        /**
         * If not null, the {@link com.jochems.casinocoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.jochems.casinocoin.wallet.WalletFiles.Listener)}
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.jochems.casinocoin.crypto.KeyCrypter,
     ...
     * {@link com.jochems.casinocoin.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.jochems.casinocoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.jochems.casinocoin.utils.Threading#waitForUserCode()} to block until the future had a
