...
import com.jochems.casinocoin.net.AbstractTimeoutHandler;
import com.jochems.casinocoin.net.MessageWriteTarget;
import com.jochems.casinocoin.net.StreamParser;
...
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.jochems.casinocoin.net.NioClient} or
     * {@link com.jochems.casinocoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
