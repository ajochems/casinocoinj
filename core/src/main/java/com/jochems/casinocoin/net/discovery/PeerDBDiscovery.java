...
package com.jochems.casinocoin.net.discovery;
...
public class PeerDBDiscovery implements PeerDiscovery {
    ...
    /**
     * Creates a PeerDB for the given {@link com.jochems.casinocoin.core.PeerGroup}, adding this as a PeerDiscovery to the given group.
     */
    ...
    /**
     * Attaches a {@link PeerEventListener} to the given {@link PeerGroup} which listens for {@link com.jochems.casinocoin.core.AddressMessage}
