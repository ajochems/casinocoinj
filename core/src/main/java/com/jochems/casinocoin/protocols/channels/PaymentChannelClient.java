...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     * {@link ClientConnection#destroyConnection(com.jochems.casinocoin.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link ClientConnection#destroyConnection(com.jochems.casinocoin.protocols.channels.PaymentChannelCloseException.CloseReason)} to settle the connection, it does not
