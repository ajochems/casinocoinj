...
public class PaymentChannelServer {
     ...
     * {@link ServerConnection#destroyConnection(com.jochems.casinocoin.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link ServerConnection#destroyConnection(com.jochems.casinocoin.protocols.channels.PaymentChannelCloseException.CloseReason)}. Note that this does not broadcast
