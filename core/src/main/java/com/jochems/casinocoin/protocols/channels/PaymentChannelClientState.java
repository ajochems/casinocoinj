...
package com.jochems.casinocoin.protocols.channels;
...
import com.jochems.casinocoin.wallet.AllowUnconfirmedCoinSelector;
 ...
 * You must then call {@link PaymentChannelClientState#storeChannelInWallet(com.jochems.casinocoin.core.Sha256Hash)} to store the refund transaction
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.jochems.casinocoin.core.Wallet.SendRequest)}.
     ...
     * later.
     *
     * @see PaymentChannelClientState#storeChannelInWallet(com.jochems.casinocoin.core.Sha256Hash)
     */
